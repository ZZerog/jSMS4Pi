...
public class CPINquestion extends AAT {
	...
	private final Pattern pattern = Pattern.compile(
			"\\+CPIN: *(READY|SIM PIN|SIM PUK|PH-SIM PIN|PS-FSIM PIN|PH-FSIM PUK|SIP PIN2|SIM PUK2|PH-NET PIN|PH-NET PUK|PH-NETSUB PIN|PH-NETSUB PUK|PH-SP PIN|PH-SP PUK|PH-CORP PIN|PH-CORP PUK)\\s*");
	...
	public enum PinStatus {
		...
		PH_FSIM_PIN, // MT is waiting phone-to-very first SIM card password to
						// be given
		PH_FSIM_PUN, // MT is waiting phone-to-very first SIM card unblocking
		 ...
		 * right after the failure, it is recommended that MT does not block its
		 * operation)
		 */
		SIM_PIN2,
		/*
		 ...
		 * are not entered right after the failure, it is recommended that MT
		 * does not block its operation)
		 */
		SIM_PUK2,
		PH_NET_PIN, // MT is waiting network personalization password to be
					// given
		PH_NET_PUK, // MT is waiting network personalization unblocking password
					// to be given
		PH_NETSUB_PIN, // MT is waiting network subset personalization password
						// to be given
		PH_NETSUB_PUK, // MT is waiting network subset personalization
						// unblocking password to be given
		PH_SP_PIN, // MT is waiting service provider personalization password to
					// be given
		PH_SP_PUK, // MT is waiting service provider personalization unblocking
					// password to be given
		PH_CORP_PIN, // MT is waiting corporate personalization password to be
						// given
		PH_CORP_PUK; // MT is waiting corporate personalization unblocking
						// password to be given
